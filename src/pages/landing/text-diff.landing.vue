...
useHead({
  title: 'Text Diff Comparator - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Compare two texts and find differences. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'text diff, text compare, diff tool, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'Text Diff Comparator - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Compare two texts and find differences. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/text-diff' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/text-diff' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is Text Diff Comparator?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Compare two texts and find differences. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use Text Diff Comparator?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is Text Diff Comparator free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, Text Diff Comparator is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/text-diff'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>Text Diff Comparator</h1><p class="subtitle">Compare two texts and find differences</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is Text Diff Comparator?</h3><p>Compare two texts and find differences.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
