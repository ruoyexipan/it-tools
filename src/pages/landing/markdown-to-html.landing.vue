...
useHead({
  title: 'Markdown to HTML Converter - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Convert Markdown to HTML. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'markdown to html, md to html, markdown converter, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'Markdown to HTML Converter - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Convert Markdown to HTML. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/markdown-to-html' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/markdown-to-html' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is Markdown to HTML Converter?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Convert Markdown to HTML. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use Markdown to HTML Converter?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is Markdown to HTML Converter free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, Markdown to HTML Converter is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/markdown-to-html'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>Markdown to HTML Converter</h1><p class="subtitle">Convert Markdown to HTML</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is Markdown to HTML Converter?</h3><p>Convert Markdown to HTML.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
