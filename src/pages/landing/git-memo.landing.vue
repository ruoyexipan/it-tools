...
useHead({
  title: 'Git Commands Cheatsheet - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Git commands reference and cheatsheet. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'git commands, git cheatsheet, git reference, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'Git Commands Cheatsheet - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Git commands reference and cheatsheet. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/git-memo' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/git-memo' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is Git Commands Cheatsheet?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Git commands reference and cheatsheet. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use Git Commands Cheatsheet?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is Git Commands Cheatsheet free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, Git Commands Cheatsheet is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/git-memo'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>Git Commands Cheatsheet</h1><p class="subtitle">Git commands reference and cheatsheet</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is Git Commands Cheatsheet?</h3><p>Git commands reference and cheatsheet.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
