...
useHead({
  title: 'XML Formatter Online - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Format and prettify XML. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'xml formatter, xml beautifier, xml prettify, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'XML Formatter Online - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Format and prettify XML. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/xml-formatter' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/xml-formatter' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is XML Formatter Online?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Format and prettify XML. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use XML Formatter Online?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is XML Formatter Online free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, XML Formatter Online is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/xml-formatter'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>XML Formatter Online</h1><p class="subtitle">Format and prettify XML</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is XML Formatter Online?</h3><p>Format and prettify XML.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
