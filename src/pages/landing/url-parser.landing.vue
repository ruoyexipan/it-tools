...
useHead({
  title: 'URL Parser Online - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Parse and analyze URLs. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'url parser, url analyzer, url breakdown, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'URL Parser Online - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Parse and analyze URLs. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/url-parser' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/url-parser' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is URL Parser Online?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Parse and analyze URLs. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use URL Parser Online?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is URL Parser Online free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, URL Parser Online is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/url-parser'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>URL Parser Online</h1><p class="subtitle">Parse and analyze URLs</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is URL Parser Online?</h3><p>Parse and analyze URLs.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
