...
useHead({
  title: 'YAML Viewer Online - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'View and explore YAML data. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'yaml viewer, yaml explorer, yaml formatter, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'YAML Viewer Online - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'View and explore YAML data. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/yaml-viewer' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/yaml-viewer' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is YAML Viewer Online?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'View and explore YAML data. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use YAML Viewer Online?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is YAML Viewer Online free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, YAML Viewer Online is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/yaml-prettify'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>YAML Viewer Online</h1><p class="subtitle">View and explore YAML data</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is YAML Viewer Online?</h3><p>View and explore YAML data.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
