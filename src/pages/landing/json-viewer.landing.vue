...
useHead({
  title: 'JSON Viewer Online - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'View and explore JSON data. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'json viewer, json explorer, json tree, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'JSON Viewer Online - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'View and explore JSON data. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/json-viewer' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/json-viewer' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is JSON Viewer Online?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'View and explore JSON data. It is a free online tool that works directly in your browser.' } },
...
<template>
  <div class="landing-page">
    ...
    <div class="hero"><h1>JSON Viewer Online</h1><p class="subtitle">View and explore JSON data</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is JSON Viewer Online?</h3><p>View and explore JSON data.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
