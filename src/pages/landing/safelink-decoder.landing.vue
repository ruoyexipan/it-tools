...
useHead({
  title: 'Outlook SafeLink Decoder - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Decode Outlook SafeLink URLs. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'safelink decoder, outlook safelink, url decoder, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'Outlook SafeLink Decoder - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Decode Outlook SafeLink URLs. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/safelink-decoder' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/safelink-decoder' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is Outlook SafeLink Decoder?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Decode Outlook SafeLink URLs. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use Outlook SafeLink Decoder?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is Outlook SafeLink Decoder free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, Outlook SafeLink Decoder is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/safelink-decoder'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>Outlook SafeLink Decoder</h1><p class="subtitle">Decode Outlook SafeLink URLs</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is Outlook SafeLink Decoder?</h3><p>Decode Outlook SafeLink URLs.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
