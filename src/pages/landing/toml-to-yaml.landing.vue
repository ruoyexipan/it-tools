...
useHead({
  title: 'TOML to YAML Converter - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Convert TOML to YAML format. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'toml to yaml, toml converter, yaml converter, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'TOML to YAML Converter - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Convert TOML to YAML format. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/toml-to-yaml' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/toml-to-yaml' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is TOML to YAML Converter?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Convert TOML to YAML format. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use TOML to YAML Converter?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is TOML to YAML Converter free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, TOML to YAML Converter is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/toml-to-yaml'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>TOML to YAML Converter</h1><p class="subtitle">Convert TOML to YAML format</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is TOML to YAML Converter?</h3><p>Convert TOML to YAML format.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
