...
useHead({
  title: 'JSON Minifier - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Minify and compress JSON data. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'minify json, compress json, json minifier, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'JSON Minifier - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Minify and compress JSON data. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/json-minify' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/json-minify' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is JSON Minifier?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Minify and compress JSON data. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use JSON Minifier?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is JSON Minifier free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, JSON Minifier is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/json-minify'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>JSON Minifier</h1><p class="subtitle">Minify and compress JSON data</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is JSON Minifier?</h3><p>Minify and compress JSON data.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
