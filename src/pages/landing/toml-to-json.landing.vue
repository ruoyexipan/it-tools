...
useHead({
  title: 'TOML to JSON Converter - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Convert TOML to JSON format. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'toml to json, toml converter, toml parser, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'TOML to JSON Converter - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Convert TOML to JSON format. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/toml-to-json' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/toml-to-json' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is TOML to JSON Converter?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Convert TOML to JSON format. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use TOML to JSON Converter?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is TOML to JSON Converter free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, TOML to JSON Converter is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/toml-to-json'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>TOML to JSON Converter</h1><p class="subtitle">Convert TOML to JSON format</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is TOML to JSON Converter?</h3><p>Convert TOML to JSON format.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
