...
useHead({
  title: 'YAML to TOML Converter - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Convert YAML to TOML format. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'yaml to toml, yaml converter, toml converter, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'YAML to TOML Converter - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Convert YAML to TOML format. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/yaml-to-toml' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/yaml-to-toml' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is YAML to TOML Converter?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Convert YAML to TOML format. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use YAML to TOML Converter?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is YAML to TOML Converter free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, YAML to TOML Converter is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/yaml-to-toml'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>YAML to TOML Converter</h1><p class="subtitle">Convert YAML to TOML format</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is YAML to TOML Converter?</h3><p>Convert YAML to TOML format.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
