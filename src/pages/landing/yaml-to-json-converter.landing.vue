...
useHead({
  title: 'YAML to JSON Converter - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Convert YAML to JSON format. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'yaml to json, yaml converter, json converter, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'YAML to JSON Converter - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Convert YAML to JSON format. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/yaml-to-json-converter' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/yaml-to-json-converter' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is YAML to JSON Converter?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Convert YAML to JSON format. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use YAML to JSON Converter?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is YAML to JSON Converter free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, YAML to JSON Converter is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/yaml-to-json-converter'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>YAML to JSON Converter</h1><p class="subtitle">Convert YAML to JSON format</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is YAML to JSON Converter?</h3><p>Convert YAML to JSON format.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
