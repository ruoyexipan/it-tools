...
useHead({
  title: 'JSON to YAML Converter - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Convert JSON to YAML format. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'json to yaml, yaml converter, json converter, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'JSON to YAML Converter - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Convert JSON to YAML format. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/json-to-yaml-converter' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/json-to-yaml-converter' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is JSON to YAML Converter?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Convert JSON to YAML format. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use JSON to YAML Converter?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is JSON to YAML Converter free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, JSON to YAML Converter is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/json-to-yaml-converter'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>JSON to YAML Converter</h1><p class="subtitle">Convert JSON to YAML format</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is JSON to YAML Converter?</h3><p>Convert JSON to YAML format.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
