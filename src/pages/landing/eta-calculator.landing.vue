...
useHead({
  title: 'ETA Calculator - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Calculate estimated time of arrival. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'eta calculator, arrival time, travel time, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'ETA Calculator - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Calculate estimated time of arrival. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/eta-calculator' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/eta-calculator' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is ETA Calculator?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Calculate estimated time of arrival. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use ETA Calculator?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is ETA Calculator free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, ETA Calculator is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/eta-calculator'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>ETA Calculator</h1><p class="subtitle">Calculate estimated time of arrival</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is ETA Calculator?</h3><p>Calculate estimated time of arrival.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
