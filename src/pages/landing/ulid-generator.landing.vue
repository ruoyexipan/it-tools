...
useHead({
  title: 'ULID Generator Online - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Generate ULID identifiers. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'ulid generator, unique id, sortable id, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'ULID Generator Online - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Generate ULID identifiers. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/ulid-generator' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/ulid-generator' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is ULID Generator Online?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Generate ULID identifiers. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use ULID Generator Online?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is ULID Generator Online free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, ULID Generator Online is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/ulid-generator'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>ULID Generator Online</h1><p class="subtitle">Generate ULID identifiers</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is ULID Generator Online?</h3><p>Generate ULID identifiers.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
