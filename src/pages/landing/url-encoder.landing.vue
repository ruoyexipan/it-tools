...
useHead({
  title: 'URL Encoder Decoder - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Encode and decode URLs online. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'url encoder, url decoder, percent encoding, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'URL Encoder Decoder - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Encode and decode URLs online. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/url-encoder' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/url-encoder' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is URL Encoder Decoder?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Encode and decode URLs online. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use URL Encoder Decoder?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is URL Encoder Decoder free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, URL Encoder Decoder is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/url-encoder'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>URL Encoder Decoder</h1><p class="subtitle">Encode and decode URLs online</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is URL Encoder Decoder?</h3><p>Encode and decode URLs online.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
