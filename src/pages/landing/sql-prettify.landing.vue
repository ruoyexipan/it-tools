...
useHead({
  title: 'SQL Formatter Online - Free Online Tool | AgentsAITools',
  meta: [
    { name: 'description', content: 'Format and prettify SQL queries. Free online tool by AgentsAITools - no signup required. Fast, secure, and easy to use.' },
    { name: 'keywords', content: 'sql formatter, sql beautifier, sql prettify, online tool, free tool, developer tool' },
    { property: 'og:title', content: 'SQL Formatter Online - Free Online Tool | AgentsAITools' },
    { property: 'og:description', content: 'Format and prettify SQL queries. Free tool, no signup required.' },
    { property: 'og:url', content: 'https://agentsaitools.com/sql-prettify' },
  ],
  link: [{ rel: 'canonical', href: 'https://agentsaitools.com/sql-prettify' }],
});
const faqJsonLd = { '@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [
  { '@type': 'Question', 'name': 'What is SQL Formatter Online?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Format and prettify SQL queries. It is a free online tool that works directly in your browser.' } },
  { '@type': 'Question', 'name': 'How to use SQL Formatter Online?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Simply enter your input data and the tool will process it instantly. No signup or installation required.' } },
  { '@type': 'Question', 'name': 'Is SQL Formatter Online free?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, SQL Formatter Online is completely free to use. No signup required. All processing happens in your browser.' } },
]};
function goToTool() { router.push('/sql-prettify'); }
</script>
<template>
  <div class="landing-page">
    <script type="application/ld+json">{{ JSON.stringify(faqJsonLd) }}</script>
    <div class="hero"><h1>SQL Formatter Online</h1><p class="subtitle">Format and prettify SQL queries</p><button class="cta-button" @click="goToTool">Use Tool →</button></div>
    ...
    <div class="faq"><h2>FAQ</h2><div class="faq-item"><h3>What is SQL Formatter Online?</h3><p>Format and prettify SQL queries.</p></div><div class="faq-item"><h3>Is it free?</h3><p>Yes, completely free. No signup required.</p></div></div>
