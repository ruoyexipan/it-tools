...
const pages = [
  ...
  // Crypto 工具
  {
    ...
    keywords: 'token generator, random string, api key generator, password generator, secure token, random token, generate api key, random password, secure password generator, authentication token',
    category: 'Crypto',
  },
  {
    path: '/hash-text',
    ...
    keywords: 'hash generator, md5, sha256, sha512, hash tool, md5 hash generator, sha256 hash, sha512 hash, hash calculator, text hash, file hash, online hash generator, free hash tool',
    category: 'Crypto',
  },
  {
    path: '/bcrypt',
    ...
    keywords: 'bcrypt, password hash, bcrypt generator, bcrypt hash generator, password hasher, secure password hash, bcrypt online, generate bcrypt hash, password encryption',
    category: 'Crypto',
  },
  {
    path: '/uuid-generator',
    ...
    keywords: 'uuid generator, guid generator, unique id, uuid v4, generate uuid, random uuid, unique identifier, uuid online, bulk uuid generator, uuid creator',
    category: 'Crypto',
  },
  {
    path: '/ulid-generator',
    ...
    keywords: 'ulid generator, unique id, sortable id, ulid online, generate ulid, unique lexicographically sortable identifier, ulid creator',
    category: 'Crypto',
  },
  {
    path: '/encryption',
    ...
    keywords: 'encryption, decrypt, encrypt text, text encryption, online encryption, aes encryption, data encryption, secure text, encrypt decrypt tool',
    category: 'Crypto',
  },
  {
    ...
    keywords: 'bip39, mnemonic, seed phrase, crypto wallet, bip39 generator, mnemonic generator, seed phrase generator, wallet backup, recovery phrase',
    category: 'Crypto',
  },
  {
    path: '/hmac-generator',
    ...
    keywords: 'hmac, hmac generator, hash message authentication, hmac sha256, hmac sha1, api authentication, message authentication code, hmac online',
    category: 'Crypto',
  },
  {
    ...
    keywords: 'rsa, key pair, encryption key, rsa key generator, public private key, rsa key pair, ssl certificate, encryption keys',
    category: 'Crypto',
  },
  {
    ...
    keywords: 'password strength, password checker, password analyzer, check password strength, password security, strong password, password validator, password tester',
    category: 'Crypto',
  },
  {
    ...
    keywords: 'pdf signature, digital signature, pdf validator, verify pdf signature, pdf certificate, document signature, signature verification',
    category: 'Crypto',
  },
  // Converter 工具
  {
    ...
    keywords: 'date converter, timestamp converter, unix timestamp, epoch converter, timestamp to date, date format converter, time converter, unix time, date calculator',
    category: 'Converter',
  },
  {
    path: '/base-converter',
    ...
    keywords: 'base converter, binary converter, hex converter, decimal converter, number base converter, binary to decimal, hex to decimal, octal converter, number system converter',
    category: 'Converter',
  },
  {
    ...
    keywords: 'roman numerals, roman converter, roman numeral converter, number to roman, roman to number, roman numeral calculator',
    category: 'Converter',
  },
  {
    ...
    keywords: 'base64, encoder, decoder, base64 converter, base64 encode, base64 decode, base64 string, text to base64, base64 to text, online base64',
    category: 'Converter',
  },
  {
    ...
    keywords: 'base64 file, file converter, encode file, base64 encode file, file to base64, base64 download, convert file base64',
    category: 'Converter',
  },
  {
    ...
    keywords: 'color converter, hex to rgb, rgb to hex, hsl, color code converter, color picker, hex color, rgb color, color format, css color converter',
    category: 'Converter',
  },
  {
    path: '/case-converter',
    ...
    keywords: 'case converter, uppercase, lowercase, title case, text case, convert case, case changer, text transform, capitalize, sentence case',
    category: 'Converter',
  },
  {
    ...
    keywords: 'nato alphabet, phonetic alphabet, military alphabet, nato phonetic, alphabet converter, spelling alphabet',
    category: 'Converter',
  },
  {
    path: '/text-to-binary',
    ...
    keywords: 'text to binary, binary converter, text to binary converter, ascii to binary, binary code, convert text binary, binary translator',
    category: 'Converter',
  },
  {
    ...
    keywords: 'text to unicode, unicode converter, character code, unicode code, text to unicode converter, ascii to unicode',
    category: 'Converter',
  },
  {
    ...
    keywords: 'yaml to json, yaml converter, yaml parser, convert yaml, yaml to json converter, yaml json, yaml format',
    category: 'Converter',
  },
  {
    path: '/yaml-to-toml',
    ...
    keywords: 'yaml to toml, yaml converter, toml converter, yaml toml converter, config converter',
    category: 'Converter',
  },
  {
    ...
    keywords: 'json to yaml, json converter, json yaml, json to yaml converter, json formatter yaml',
    category: 'Converter',
  },
  {
    path: '/json-to-toml',
    ...
    keywords: 'json to toml, json converter, toml converter, json toml, config file converter',
    category: 'Converter',
  },
  {
    path: '/list-converter',
    ...
    keywords: 'list converter, list format, text list, csv to list, list to csv, array converter, list transform',
    category: 'Converter',
  },
  {
    path: '/toml-to-json',
    ...
    keywords: 'toml to json, toml converter, toml parser, toml json, config file converter, toml format',
    category: 'Converter',
  },
  {
    path: '/toml-to-yaml',
    ...
    keywords: 'toml to yaml, toml converter, yaml converter, toml yaml, config converter',
    category: 'Converter',
  },
  {
    path: '/xml-to-json',
    ...
    keywords: 'xml to json, xml converter, xml parser, xml json converter, xml to json online, convert xml',
    category: 'Converter',
  },
  {
    path: '/json-to-xml',
    ...
    keywords: 'json to xml, json converter, xml converter, json xml, json to xml converter, json xml online',
    category: 'Converter',
  },
  {
    ...
    keywords: 'markdown to html, markdown converter, md to html, markdown html, markdown renderer, markdown preview',
    category: 'Converter',
  },
  // Web 工具
  {
    ...
    keywords: 'url encoder, url decoder, percent encoding, encode url, decode url, url encode decode, url encoding online',
    category: 'Web',
  },
  {
    path: '/html-entities',
    ...
    keywords: 'html entities, html encoder, html decoder, html special characters, html entity encoder, escape html, html entities list',
    category: 'Web',
  },
  {
    path: '/url-parser',
    ...
    keywords: 'url parser, url analyzer, url decoder, parse url, url components, url structure, url breakdown',
    category: 'Web',
  },
  {
    ...
    keywords: 'device info, browser info, user agent, device details, browser detection, system info, screen resolution',
    category: 'Web',
  },
  {
    ...
    keywords: 'basic auth, authorization header, http auth, basic authentication, auth header generator, base64 auth',
    category: 'Web',
  },
  {
    ...
    keywords: 'meta tag generator, og tags, seo meta tags, open graph, twitter cards, social media tags, meta description generator',
    category: 'Web',
  },
  {
    path: '/otp-generator',
    ...
    keywords: 'otp generator, totp, hotp, 2fa, one time password, authenticator, otp code, two factor authentication, google authenticator',
    category: 'Web',
  },
  {
    path: '/mime-types',
    ...
    keywords: 'mime types, content type, file type, mime type lookup, file extension, media type, mime type list',
    category: 'Web',
  },
  {
    path: '/jwt-parser',
    ...
    keywords: 'jwt parser, jwt decoder, json web token, jwt decode, jwt validator, jwt viewer, token decoder, jwt inspector',
    category: 'Web',
  },
  {
    path: '/keycode-info',
    ...
    keywords: 'keycode, keyboard code, key event, keyboard shortcut, key code viewer, javascript keycode, keyboard input',
    category: 'Web',
  },
  {
    path: '/slugify-string',
    ...
    keywords: 'slug generator, url slug, slugify, url friendly, slug creator, url slug generator, text to slug',
    category: 'Web',
  },
  {
    ...
    keywords: 'html editor, wysiwyg editor, visual editor, html editor online, rich text editor, html code editor',
    category: 'Web',
  },
  {
    ...
    keywords: 'user agent parser, browser detection, user agent string, browser info, parse user agent, user agent detector',
    category: 'Web',
  },
  {
    ...
    keywords: 'http status codes, http codes, status code list, http error codes, web status codes, http response codes',
    category: 'Web',
  },
  {
    path: '/json-diff',
    ...
    keywords: 'json diff, json compare, json difference, compare json, json diff tool, json comparison, json merge diff',
    category: 'Web',
  },
  {
  ...
  // Development 工具
  {
    ...
    keywords: 'git commands, git cheatsheet, git reference, git tutorial, git guide, git basics, git workflow, git tips',
  ...
  },
  {
    ...
    keywords: 'random port, port generator, network port, random port number, port number generator, tcp port',
    category: 'Development',
  },
  {
    ...
    keywords: 'crontab generator, cron expression, cron schedule, cron job, crontab syntax, cron timer, task scheduler',
    category: 'Development',
  },
  {
    path: '/json-prettify',
    ...
    keywords: 'json formatter, json prettify, json validator, json beautifier, format json, json viewer, json editor, json parser, json linter',
    category: 'Development',
  },
  {
    path: '/json-minify',
    ...
    keywords: 'json minify, compress json, json minifier, reduce json size, json optimizer, json compact, minify json online',
    category: 'Development',
  },
  {
    path: '/json-to-csv',
    ...
    keywords: 'json to csv, json csv converter, json to spreadsheet, csv converter, json export csv, convert json csv',
    category: 'Development',
  },
  {
    path: '/sql-prettify',
    ...
    keywords: 'sql formatter, sql beautifier, sql prettifier, format sql, sql code formatter, sql query formatter, sql editor',
    category: 'Development',
  },
  {
    ...
    keywords: 'chmod calculator, linux permissions, file permissions, chmod command, unix permissions, permission calculator, chmod octal',
    category: 'Development',
  },
  {
    ...
    keywords: 'docker converter, docker compose, docker run, docker run to compose, docker compose converter, docker yaml, container orchestration',
    category: 'Development',
  },
  {
    path: '/xml-formatter',
    ...
    keywords: 'xml formatter, xml beautifier, xml prettifier, format xml, xml editor, xml validator, xml viewer',
    category: 'Development',
  },
  {
    path: '/yaml-prettify',
    ...
    keywords: 'yaml viewer, yaml formatter, yaml editor, yaml validator, yaml prettifier, yaml parser, yaml viewer online',
    category: 'Development',
  },
  {
    ...
    keywords: 'email normalizer, email validator, email format, email checker, email verifier, normalize email, email cleanup',
    category: 'Development',
  },
  {
    path: '/regex-tester',
    ...
    keywords: 'regex tester, regex validator, regular expression, regex online, test regex, regex checker, pattern matching, regex debugger',
    category: 'Development',
  },
  {
    path: '/regex-memo',
    ...
    keywords: 'regex cheatsheet, regex reference, regex guide, regex examples, regex patterns, regular expressions cheat sheet',
    category: 'Development',
  },
  // Network 工具
  {
    ...
    keywords: 'subnet calculator, cidr calculator, ip subnet, network calculator, ip range, subnet mask, ipv4 subnet, network address',
    category: 'Network',
  },
  {
    ...
    keywords: 'ipv4 converter, ip address converter, ip converter, ipv4 address, ip format converter, ip calculator',
    category: 'Network',
  },
  {
    ...
    keywords: 'ipv4 range, ip range expander, ip range calculator, ip address range, subnet range, ip list generator',
    category: 'Network',
  },
  {
    ...
    keywords: 'mac address lookup, mac vendor, oui lookup, mac address vendor, network card lookup, mac manufacturer',
    category: 'Network',
  },
  {
    ...
    keywords: 'mac address generator, random mac, mac generator, generate mac address, network card address',
    category: 'Network',
  },
  {
    ...
    keywords: 'ipv6 ula, ipv6 generator, unique local address, ipv6 address, ipv6 prefix generator',
    category: 'Network',
  },
  // Math 工具
  {
    ...
    keywords: 'math evaluator, calculator, math expression, math calculator, equation solver, math formula, calculate expression',
    category: 'Math',
  },
  {
    path: '/eta-calculator',
    ...
    keywords: 'eta calculator, arrival time, travel time, time calculator, distance time, speed calculator',
    category: 'Math',
  },
  {
    ...
    keywords: 'percentage calculator, percent calc, percentage change, percent increase, percent decrease, calculate percentage',
    category: 'Math',
  },
  // Measurement 工具
  {
  ...
  // Text 工具
  {
    ...
    keywords: 'lorem ipsum, placeholder text, dummy text, lorem generator, fake text, sample text, text generator',
    category: 'Text',
  },
  {
    ...
    keywords: 'text statistics, word count, character count, text analysis, word counter, letter count, text metrics',
    category: 'Text',
  },
  {
    path: '/emoji-picker',
    ...
    keywords: 'emoji picker, emoji list, emoji search, copy emoji, emoji finder, emoji browser, emoji collection',
    category: 'Text',
  },
  {
    ...
    keywords: 'string obfuscator, text mask, hide text, text obfuscation, string masking, data masking',
    category: 'Text',
  },
  {
    path: '/text-diff',
    ...
    keywords: 'text diff, text compare, diff tool, compare text, text comparison, find differences, merge diff',
    category: 'Text',
  },
  {
    ...
    keywords: 'numeronym generator, abbreviation, acronym, word abbreviation, shorten word, numeronym creator',
    category: 'Text',
  },
  {
    ...
    keywords: 'ascii art, text art, ascii text, ascii drawing, text drawing, ascii generator, ascii creator',
    category: 'Text',
  },
  // Data 工具
  {
    ...
    keywords: 'phone parser, phone formatter, phone validator, phone number, international phone, phone lookup',
    category: 'Data',
  },
  {
    ...
    keywords: 'iban validator, iban check, iban parser, bank account, international bank, iban verification',
    category: 'Data',
  },
  // New tools
  {
