...
const pages = [
  ...
  },
  {
    ...
    description: 'Generate MD5, SHA1, SHA256, SHA384, SHA512, and RIPEMD160 hashes online. Free hash generator tool for text and files. Supports multiple algorithms with instant results.',
  ...
  },
  {
    ...
    description: 'Generate UUID v4 identifiers online. Free UUID generator tool for creating unique identifiers for databases, applications, and distributed systems. Bulk generation supported.',
  ...
  },
  {
    ...
    description: 'Encode and decode Base64 strings online. Free Base64 converter tool supporting text and file encoding. Instant conversion with copy-to-clipboard functionality.',
  ...
  },
  {
    ...
    description: 'Convert colors between HEX, RGB, HSL, HSV, and CMYK formats online. Free color converter with color picker and palette generator. Perfect for designers and developers.',
  ...
  },
  {
    ...
    description: 'Decode and parse JWT (JSON Web Token) tokens online. Free JWT decoder that displays header, payload, and signature. Validate tokens and check expiration.',
  ...
  },
  {
    ...
    description: 'Generate crontab expressions online with human-readable descriptions. Free crontab generator supporting all cron syntax. Schedule tasks with visual interface.',
  ...
  },
  {
    ...
    description: 'Format, validate, and prettify JSON data online. Free JSON formatter with syntax highlighting, error detection, and minification. Instant formatting with copy.',
  ...
  },
  {
    ...
    description: 'Test regular expressions online with real-time matching. Free regex tester with syntax highlighting, capture groups, and match details. Supports all regex flavors.',
